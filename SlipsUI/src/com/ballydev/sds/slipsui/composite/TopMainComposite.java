...
public class TopMainComposite extends Composite {
	...
	private Composite leftBorderComposite = null;
	...
	private void createLeftBorederComposite() {
		...
		leftBorderComposite = new Composite(this, SWT.NONE);
		leftBorderComposite.setBackground(SDSControlFactory.getTouchScreenHomeBackgroundColor());
		leftBorderComposite.setLayout(gridLayout1);
		leftBorderComposite.setLayoutData(gridData1);
	}
	...
	private void createCenterComposite() {
		...
		centerComposite.setBackground(new Color(Display.getCurrent(), 255, 255, 255));
