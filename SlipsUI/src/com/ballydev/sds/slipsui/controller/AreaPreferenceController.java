/*****************************************************************************
 * $Id: AreaPreferenceController.java,v 1.6, 2010-03-03 17:03:04Z, Suganthi, Kaliamoorthy$
 * $Date: 3/3/2010 11:03:04 AM$
 *****************************************************************************
...
import com.ballydev.sds.slipsui.AreaPreferenceItem;
...
public class AreaPreferenceController extends SDSBaseController{
	...
	public void widgetSelected(SelectionEvent e) {		
		try{
			if(areaPreferenceForm!=null){				
				Control ctrl = ((Control)e.getSource());
				if((ctrl instanceof SDSButton)){
					populateForm(areaPreferenceComposite);
					SDSButton button = (SDSButton)ctrl;	
