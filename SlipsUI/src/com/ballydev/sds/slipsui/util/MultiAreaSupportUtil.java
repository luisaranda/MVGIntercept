/*****************************************************************************
 * $Id: MultiAreaSupportUtil.java,v 1.2, 2009-03-20 17:43:27Z, Ambereen Drewitt$
 * $Date: 3/20/2009 11:43:27 AM$
 *****************************************************************************
...
public class MultiAreaSupportUtil {
	...
	public static boolean isMultiAreaSupportEnabled(){
		...
		try{
			...
			String boolValueGot = sessionUtility.getSiteConfigurationValue(ISiteConfigurationConstants.MULTI_AREA_SUPPORT_FOR_SLIP_COMMANDS);
	...
	/**
	 * Method to get the Area Ids for the selected area names in the Slip Area Preferences
	 * @return
	 */
	public static ArrayList<String> getAreaIdsForPrefAreaNames()
	{
		...
		String alreadySelectedAreas = SDSPreferenceStore.getStringStoreValue(IAppConstants.SLIP_AREA_PREFERENCE_KEY);
