/*****************************************************************************
 * $Id: TouchScreenRadioButton.java,v 1.1, 2008-11-19 05:28:38Z, Ambereen Drewitt$
 * $Date: 11/18/2008 11:28:38 PM$
 *****************************************************************************
	...
	public void refreshControl(Object form) {
		if (getFormProperty() != null && !(getFormProperty().equals(""))) {
			...
			try {
				...
				log.debug(" TouchScreenRadioButton refresh control checkValue "
						+ checkValue);
				this.setSelected(checkValue!=null && checkValue.booleanValue());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void refreshForm(Object form) {
		if (getFormProperty() != null && !getFormProperty().equals("")) {
			...
			try {
				...
				log.debug(" TouchScreenRadioButton refresh form  chkValue "
						+ chkValue);
				if (chkValue == null) {
					return;
				}
