/*****************************************************************************
 * $Id: PrintDTO.java,v 1.10.4.0, 2013-10-12 09:01:12Z, SDS12.3.3 Checkin User$
...
public class PrintDTO {	
	 ...
	 * Amount in writing
	 */
	private String amountInWriting;
	
	// 	BELOW FIVE FIELDS ARE FOR THE MULTI RANGE JACKPOT SIGNATURES
	private String executiveTwo;
	private String executiveOne;
	...
	/*
	 * jackpot State tax amount 
	 */
	private String jpStateTaxAmount;
	
	/*
	 * jackpot State tax amount 
	 */
	private String jpFederalTaxAmount;
	
	
		/*
	 * jackpot State tax amount 
	 */
	private String jpMunicipalTaxAmount;
	
	/*
	 * jackpot State tax rate 
	 */
	private String jpStateTaxRate;
	
	/*
	 * jackpot Federal tax rate 
	 */
	private String jpFederalTaxRate;
	
	/*
	 * jackpot Municipal tax rate 
	 */
	private String jpMunicipalTaxRate;
	/**
	 * Slot Attendant Name
	 */
	...
	*//**
	...
	public void setSequenceNumber(String sequenceNumber) {
		this.sequenceNumber = IAppConstants.JACKPOT_SLIP_SEQUENCE_NO_PREFIX + sequenceNumber;
	}
	/**
	 * @return the shift
	 */
	...
	/**
	 * @return the executiveTwo
	 */
	public String getExecutiveTwo() {
		return executiveTwo;
	}
	/**
	 * @param executiveTwo the executiveTwo to set
	 */
	public void setExecutiveTwo(String executiveTwo) {
		this.executiveTwo = executiveTwo;
	}
	/**
	 * @return the executiveOne
	 */
	public String getExecutiveOne() {
		return executiveOne;
	}
	/**
	 * @param executiveOne the executiveOne to set
	 */
	public void setExecutiveOne(String executiveOne) {
		this.executiveOne = executiveOne;
	}
	/**
	 * @return the manager
	 */
	...
	/**
	 * @return the amountInWriting
	 */
	public String getAmountInWriting() {
		return amountInWriting;
	}
	/**
	 * @param amountInWriting the amountInWriting to set
	 */
	public void setAmountInWriting(String amountInWriting) {
		this.amountInWriting = amountInWriting;
	}
	...
	/**
	 * @return the jpStateTaxAmount
	 */
	public String getJpStateTaxAmount() {
		return jpStateTaxAmount;
	}
	/**
	 * @param jpStateTaxAmount the jpStateTaxAmount to set
	 */
	public void setJpStateTaxAmount(String jpStateTaxAmount) {
		this.jpStateTaxAmount = jpStateTaxAmount;
	}
	/**
	 * @return the jpFederalTaxAmount
	 */
	public String getJpFederalTaxAmount() {
		return jpFederalTaxAmount;
	}
	/**
	 * @param jpFederalTaxAmount the jpFederalTaxAmount to set
	 */
	public void setJpFederalTaxAmount(String jpFederalTaxAmount) {
		this.jpFederalTaxAmount = jpFederalTaxAmount;
	}
	/**
	 * @return the jpMunicipalTaxAmount
	 */
	public String getJpMunicipalTaxAmount() {
		return jpMunicipalTaxAmount;
	}
	/**
	 * @param jpMunicipalTaxAmount the jpMunicipalTaxAmount to set
	 */
	public void setJpMunicipalTaxAmount(String jpMunicipalTaxAmount) {
		this.jpMunicipalTaxAmount = jpMunicipalTaxAmount;
	}
	/**
	 * @return the jpStateTaxRate
	 */
	public String getJpStateTaxRate() {
		return jpStateTaxRate;
	}
	/**
	 * @param jpStateTaxRate the jpStateTaxRate to set
	 */
	public void setJpStateTaxRate(String jpStateTaxRate) {
		this.jpStateTaxRate = jpStateTaxRate;
	}
	/**
	 * @return the jpFederalTaxRate
	 */
	public String getJpFederalTaxRate() {
		return jpFederalTaxRate;
	}
	/**
	 * @param jpFederalTaxRate the jpFederalTaxRate to set
	 */
	public void setJpFederalTaxRate(String jpFederalTaxRate) {
		this.jpFederalTaxRate = jpFederalTaxRate;
	}
	/**
	 * @return the jpMunicipalTaxRate
	 */
	public String getJpMunicipalTaxRate() {
		return jpMunicipalTaxRate;
	}
	/**
	 * @param jpMunicipalTaxRate the jpMunicipalTaxRate to set
	 */
	public void setJpMunicipalTaxRate(String jpMunicipalTaxRate) {
		this.jpMunicipalTaxRate = jpMunicipalTaxRate;
	}	
}
