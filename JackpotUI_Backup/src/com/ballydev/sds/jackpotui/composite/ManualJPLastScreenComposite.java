/*****************************************************************************
 * $Id: ManualJPLastScreenComposite.java,v 1.23, 2011-02-14 15:00:51Z, Subha Viswanathan$
 ...
 * @version $Revision: 24$
 */
public class ManualJPLastScreenComposite extends TouchScreenBaseComposite {
	/**
	 ...
	 */
	private ManualSlipStaticInfoComposite slipStaticInfoComposite = null;  //  @jve:decl-index=0:visual-constraint="126,593"
	 ...
	 * @param siteParam
	 */
	public ManualJPLastScreenComposite(Composite parent, int style,
			String[] siteParam) {
	...
	private void createWinningCombinationComposite(Composite middleComposite) {
		...
		if (siteConfigParamFlag[4].equalsIgnoreCase("yes")
			...
			lblManPlayerCard = new CbctlMandatoryLabel(winningGroupComposite, SWT.NONE, LabelLoader.getLabelValue(LabelKeyConstants.PLAYER_CARD));
			...
			lblPlayerCard = new CbctlLabel(winningGroupComposite, SWT.NONE, LabelLoader.getLabelValue(LabelKeyConstants.PLAYER_CARD));
		...
		if (siteConfigParamFlag[5].equalsIgnoreCase("yes")) {
			if( MainMenuController.jackpotSiteConfigParams.get(ISiteConfigConstants.IS_PLAYER_NAME_MANDATORY).equalsIgnoreCase("yes")) {			
				lblManPlayerName = new CbctlMandatoryLabel(winningGroupComposite, SWT.NONE, LabelLoader.getLabelValue(LabelKeyConstants.PLAYER_NAME));
				...
				lblPlayerName = new CbctlLabel(winningGroupComposite, SWT.NONE, LabelLoader.getLabelValue(LabelKeyConstants.PLAYER_NAME));
