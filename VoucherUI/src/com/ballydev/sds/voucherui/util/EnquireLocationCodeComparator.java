...
public class EnquireLocationCodeComparator extends SDSComparator {
	...
	public int compare(Object arg0, Object arg1) {
		...
		if(transactionListDTO.getSource().compareToIgnoreCase(transactionListDTO1.getSource())< 0){
			sortValue = 1;
		}
		else if(transactionListDTO.getSource().compareToIgnoreCase(transactionListDTO1.getSource())> 0){
			sortValue = -1;
		}
		else{
			sortValue = 0;
