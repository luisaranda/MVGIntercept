...
public class VoucherCountComparator extends SDSComparator {
	...
	public int compare(Object obj1, Object obj2) {
		...
		if(batchSummaryDTO.getVoucherCount() > batchSummaryDTO1.getVoucherCount()){
			sortValue = 1;
		}
		else if(batchSummaryDTO.getVoucherCount() < batchSummaryDTO1.getVoucherCount()){
			sortValue = -1;
		}
		else{
			sortValue = 0;
