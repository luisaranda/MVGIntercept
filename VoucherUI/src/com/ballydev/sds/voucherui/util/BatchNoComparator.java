...
public class BatchNoComparator extends SDSComparator {
	...
	public int compare(Object obj1, Object obj2) {
		...
		if(batchSummaryDTO.getBatchNumber() > batchSummaryDTO1.getBatchNumber()){
			sortValue = 1;
		}
		else if(batchSummaryDTO.getBatchNumber() < batchSummaryDTO1.getBatchNumber()){
			sortValue = -1;
		}
		else{
			sortValue = 0;
