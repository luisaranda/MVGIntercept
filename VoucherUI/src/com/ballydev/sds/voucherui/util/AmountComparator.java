...
public class AmountComparator extends SDSComparator {
	...
	public int compare(Object obj1, Object obj2) {
		...
		if(batchDtlDTO.getTktAmount() > batchDtlDTO1.getTktAmount()){
			sortValue = 1;
		}
		else if(batchDtlDTO.getTktAmount() < batchDtlDTO1.getTktAmount()){
			sortValue = -1;
		}
		else{
			sortValue = 0;
