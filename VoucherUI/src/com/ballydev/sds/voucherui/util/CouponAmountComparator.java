...
public class CouponAmountComparator extends SDSComparator {
	...
	public int compare(Object obj1, Object obj2) {
		...
		if(batchSummaryDTO.getCouponAmount() > batchSummaryDTO1.getCouponAmount()){
			sortValue = 1;
		}
		else if(batchSummaryDTO.getCouponAmount() < batchSummaryDTO1.getCouponAmount()){
			sortValue = -1;
		}
		else{
			sortValue = 0;
