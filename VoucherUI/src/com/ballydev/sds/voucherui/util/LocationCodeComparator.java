...
public class LocationCodeComparator extends SDSComparator {
	...
	public int compare(Object arg0, Object arg1) {
		...
		if(batchSummaryDTO.getLocCode().compareToIgnoreCase(batchSummaryDTO1.getLocCode())< 0){
			sortValue = 1;
		}
		else if(batchSummaryDTO.getLocCode().compareToIgnoreCase(batchSummaryDTO1.getLocCode())> 0){
			sortValue = -1;
		}
		else{
			sortValue = 0;
