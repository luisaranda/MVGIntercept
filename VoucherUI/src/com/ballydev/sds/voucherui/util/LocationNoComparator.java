...
/**
 * This class is a comparator class for location
 * @author Nithya Kalyani
 * @version $Revision: 2$
 * 
 */
@SuppressWarnings("unchecked")
public class LocationNoComparator extends SDSComparator {
	...
	public int compare(Object arg0, Object arg1) {
		...
		if(batchDtlDTO.getAssetConfNbr().compareToIgnoreCase(batchDtlDTO1.getAssetConfNbr())< 0){
			sortValue = 1;
		}
		else if(batchDtlDTO.getAssetConfNbr().compareToIgnoreCase(batchDtlDTO1.getAssetConfNbr())> 0){
			sortValue = -1;
		}
		else{
			sortValue = 0;
