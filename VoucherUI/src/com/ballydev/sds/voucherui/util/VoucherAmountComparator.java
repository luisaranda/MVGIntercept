...
public class VoucherAmountComparator extends SDSComparator {
	...
	public int compare(Object obj1, Object obj2) {
		...
		if(batchSummaryDTO.getVoucherAmount() > batchSummaryDTO1.getVoucherAmount()){
			sortValue = 1;
		}
		else if(batchSummaryDTO.getVoucherAmount() < batchSummaryDTO1.getVoucherAmount()){
			sortValue = -1;
		}
		else{
			sortValue = 0;
