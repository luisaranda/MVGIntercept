/*****************************************************************************
 * $Id: RevenueFlag.java,v 1.0, 2008-04-02 13:30:07Z, Ambereen Drewitt$
 * $Date: 4/2/2008 7:30:07 AM$
 *****************************************************************************
...
/**
 * This is the POJO representation of SLIP.REVENUE_FLAG
 * <p>
 ...
 * @version $Revision: 1$
 */
public class RevenueFlag implements java.io.Serializable {

	/**
	 * The logging mechanism for this class.
	 */
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( RevenueFlag.class );
	...
	/**
	 * The unique identifier defining revenue flag.
	 */
	private Short id = null;

	/**
	 * Descripton of the revenue flag.
	 */
	...
	/**
	 * SLIP.REVENUE_FLAG.SLIP_REFERENCE
	 */
	private java.util.Set<SlipReference> slipReference = null;

	/**
	 * The default constructor for POJO RevenueFlag.
	 */
	public RevenueFlag() {
		super();
		logger.debug( "Constructing POJO com.ballydev.sds.jackpotengine.db.slip.RevenueFlag" );
	}
	 ...
	 */
	public java.util.Set<SlipReference> getSlipReference() {
	 ...
	 */
	public void setSlipReference(java.util.Set<SlipReference> slipReference) {
