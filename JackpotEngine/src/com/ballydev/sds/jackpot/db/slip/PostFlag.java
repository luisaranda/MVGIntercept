/*****************************************************************************
 * $Id: PostFlag.java,v 1.0, 2008-04-02 13:29:45Z, Ambereen Drewitt$
 * $Date: 4/2/2008 7:29:45 AM$
 *****************************************************************************
...
/**
 * This is the POJO representation of SLIP.POST_FLAG
 * <p>
 ...
 * @version $Revision: 1$
 */
public class PostFlag implements java.io.Serializable {

	/**
	 * The logging mechanism for this class.
	 */
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( PostFlag.class );
	...
	/**
	 * Description of the revenue post flag.
	 */
	...
	/**
	 * SLIP.POST_FLAG.TRANSACTION
	 */
	private java.util.Set transaction = null;

	/**
	 * The default constructor for POJO PostFlag.
	 */
	public PostFlag() {
		super();
		logger.debug( "Constructing POJO com.ballydev.sds.jackpotengine.db.slip.PostFlag" );
	}
