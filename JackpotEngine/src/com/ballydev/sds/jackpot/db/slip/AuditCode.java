/*****************************************************************************
 * $Id: AuditCode.java,v 1.0, 2008-04-02 13:29:44Z, Ambereen Drewitt$
 * $Date: 4/2/2008 7:29:44 AM$
 *****************************************************************************
...
/**
 * This is the POJO representation of SLIP.AUDIT_CODE
 * <p>
 ...
 * @version $Revision: 1$
 */
public class AuditCode implements java.io.Serializable {

	/**
	 * The logging mechanism for this class.
	 */
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( AuditCode.class );
	...
	/**
	 * The unique audit key value for the user reference.
	 */
	private Short value = null;

	/**
	 * Description of the audit code.
	 */
	...
	/**
	 * SLIP.AUDIT_CODE.SLIP_REFERENCE
	 */
	...
	public AuditCode() {
		super();
		logger.debug( "Constructing POJO com.ballydev.sds.jackpotengine.db.slip.AuditCode" );
	}
