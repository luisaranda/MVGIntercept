/*****************************************************************************
 * $Id: TaxType.java,v 1.0, 2008-04-02 13:30:00Z, Ambereen Drewitt$
 * $Date: 4/2/2008 7:30:00 AM$
 *****************************************************************************
...
/**
 * This is the POJO representation of SLIP.TAX_TYPE
 * <p>
...
public class TaxType implements java.io.Serializable {
	 ...
	 */
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( TaxType.class );
	...
	/**
	 * SLIP.TAX_TYPE.JACKPOT
	 */
	private java.util.Set jackpot = null;

	/**
	 * The default constructor for POJO TaxType.
	 */
	public TaxType() {
		super();
		logger.debug( "Constructing POJO com.ballydev.sds.jackpotengine.db.slip.TaxType" );
	}
