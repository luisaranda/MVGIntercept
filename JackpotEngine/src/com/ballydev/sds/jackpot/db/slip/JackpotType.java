/*****************************************************************************
 * $Id: JackpotType.java,v 1.0, 2008-04-02 13:30:08Z, Ambereen Drewitt$
 * $Date: 4/2/2008 7:30:08 AM$
 *****************************************************************************
...
/**
 * This is the POJO representation of SLIP.JACKPOT_TYPE
 * <p>
 ...
 * @version $Revision: 1$
 */
public class JackpotType implements java.io.Serializable {

	/**
	 * The logging mechanism for this class.
	 */
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( JackpotType.class );
	...
	/**
	 * Descripton of the jackpot type.
	 */
	...
	/**
	 * SLIP.JACKPOT_TYPE.JACKPOT
	 */
	private java.util.Set jackpot = null;

	/**
	 * The default constructor for POJO JackpotType.
	 */
	public JackpotType() {
		super();
		logger.debug( "Constructing POJO com.ballydev.sds.jackpotengine.db.slip.JackpotType" );
	}
