/*****************************************************************************
 * $Id: ProcessFlag.java,v 1.0, 2008-04-02 13:29:57Z, Ambereen Drewitt$
...
/**
 * This is the POJO representation of SLIP.PROCESS_FLAG
 * <p>
 ...
 * @version $Revision: 1$
 */
public class ProcessFlag implements java.io.Serializable {

	/**
	 * The logging mechanism for this class.
	 */
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( ProcessFlag.class );
	...
	/**
	 * Descripton of the process flag.
	 */
	...
	/**
	 * SLIP.PROCESS_FLAG.SLIP_REFERENCE
	 */
	private java.util.Set slipReference = null;

	/**
	 * The default constructor for POJO ProcessFlag.
	 */
	public ProcessFlag() {
		super();
		logger.debug( "Constructing POJO com.ballydev.sds.jackpotengine.db.slip.ProcessFlag" );
	}
